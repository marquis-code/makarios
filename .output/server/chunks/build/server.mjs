...
import { ref, watch, getCurrentScope, onScopeDispose, hasInjectionContext, inject, getCurrentInstance as getCurrentInstance$1, toRef, isRef, computed, customRef, shallowRef, defineAsyncComponent, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, reactive, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, mergeProps, withCtx, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { t as parseURL, v as encodePath, w as decodePath, x as klona, y as hasProtocol, z as isScriptProtocol, r as joinURL, A as withQuery, B as defuFn, C as sanitizeStatusCode, D as getRequestHeader, E as isEqual, F as getContext, G as setCookie, H as getCookie, I as deleteCookie, $ as $fetch$1, J as baseURL, K as hash, L as defu, m as createError$1, M as executeAsync, N as getRequestURL, O as createDefu, P as parsePath, Q as parseQuery, R as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrInterpolate } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "conferences-id",
    path: "/conferences/:id()",
    component: () => import('./_id_-DGi4jfSc.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DKPhLu5i.mjs')
  },
  {
    name: "abstracts",
    path: "/abstracts",
    component: () => import('./abstracts-Bxk6zxEY.mjs')
  },
  {
    name: "appointments",
    path: "/appointments",
    component: () => import('./appointments-CUTu49ir.mjs')
  },
  {
    name: "conferences",
    path: "/conferences",
    component: () => import('./index-DX0xGNTP.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DVAspxKK.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./gallery-IMgEX621.mjs')
  },
  {
    name: "membership",
    path: "/membership",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./membership-CNtjxi7X.mjs')
  },
  {
    name: "newsletters",
    path: "/newsletters",
    meta: __nuxt_page_meta || {},
    component: () => import('./newsletters-Cmlc5seL.mjs')
  },
  {
    name: "payment",
    path: "/payment",
    component: () => import('./payment-COsvGG98.mjs')
  },
  {
    name: "payment-callback",
    path: "/payment-callback",
    component: () => import('./payment-callback-CtQSG8De.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-B_BarH7T.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-DeID0oWk.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-ZTL0kxB6.mjs')
  }
];
...
const LazyEmptyState = defineAsyncComponent(() => import('./EmptyState-OBLGlnua.mjs').then((r) => r["default"] || r.default || r));
const LazyLoadingState = defineAsyncComponent(() => import('./LoadingState-kkp6HvNz.mjs').then((r) => r["default"] || r.default || r));
const LazyScreenLoader = defineAsyncComponent(() => Promise.resolve().then(() => ScreenLoader).then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-C2XScDlG.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["EmptyState", LazyEmptyState],
  ["LoadingState", LazyLoadingState],
  ["ScreenLoader", LazyScreenLoader],
  ["Icon", LazyIcon]
];
  ...
  en: [
    {
      ...
      load: () => import(
        './en-D1NAwY0V.mjs'
        /* webpackChunkName: "locale_en_46json_5a39566e" */
      ),
      cache: true
    }
  ],
  fr: [
    {
      ...
      load: () => import(
        './fr-YAP67OSp.mjs'
        /* webpackChunkName: "locale_fr_46json_35ce61a2" */
      ),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => import(
        './es-Ct6C1c_A.mjs'
        /* webpackChunkName: "locale_es_46json_ee44e4e0" */
      ),
      cache: true
    }
  ],
  pt: [
    {
      ...
      load: () => import(
        './pt-YaflDX6T.mjs'
        /* webpackChunkName: "locale_pt_46json_d6f2aba6" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { en: "a394488f", fr: "a394488f", es: "a394488f", pt: "a394488f" };
...
var define_I18N_LOCALE_HASHES_default = { en: "a394488f", fr: "a394488f", es: "a394488f", pt: "a394488f" };
...
const _imports_0 = "" + __buildAssetsURL("logo.DbZOm-kL.jpeg");
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.loading) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 z-[1000] bg-slate-50 flex items-center justify-center overflow-hidden" }, _attrs))} data-v-980deb40><div class="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-cyan/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" data-v-980deb40></div><div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-brand-blue/5 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2" data-v-980deb40></div><div class="relative flex flex-col items-center gap-8" data-v-980deb40><div class="absolute inset-0 flex items-center justify-center" data-v-980deb40><div class="w-32 h-32 border-2 border-brand-cyan/30 rounded-full animate-ping-slow" data-v-980deb40></div><div class="absolute w-40 h-40 border-2 border-brand-blue/20 rounded-full animate-ping-slower" data-v-980deb40></div></div><div class="relative w-32 h-32 bg-white rounded-3xl p-4 shadow-2xl flex items-center justify-center animate-pulse-gentle" data-v-980deb40><img${ssrRenderAttr("src", _imports_0)} alt="SCPSN Logo" class="object-contain" data-v-980deb40></div><div class="flex flex-col items-center" data-v-980deb40><h2 class="text-[11px] font-black -[0.4em] text-brand-blue mb-1" data-v-980deb40>SCPSN Scientific Portal</h2><div class="flex gap-1.5 mt-2" data-v-980deb40><!--[-->`);
        ssrRenderList(3, (i) => {
          _push(`<span class="w-1.5 h-1.5 bg-brand-cyan rounded-full animate-bounce" style="${ssrRenderStyle({ animationDelay: `${i * 150}ms` })}" data-v-980deb40></span>`);
        });
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/global/ScreenLoader.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-980deb40"]]);
const ScreenLoader = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed bottom-6 right-6 z-[9999] flex flex-col gap-3 pointer-events-none" }, _attrs))} data-v-49baec65><!--[-->`);
      ssrRenderList(unref(toasts2), (toast) => {
        _push(`<div class="px-5 py-3 bg-brand-dark/95 backdrop-blur-md text-white rounded-xl shadow-2xl font-bold flex items-center gap-3 border border-white/10 text-sm" data-v-49baec65><div class="w-2 h-2 bg-brand-cyan rounded-full animate-pulse" data-v-49baec65></div> ${ssrInterpolate(toast.message)}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-49baec65"]]);
const layouts = {
  default: defineAsyncComponent(() => import('./default-CEarBHkH.mjs').then((m) => m.default || m))
};
...
const useTokenManager = () => {
  ...
  const refreshAccessToken = async (baseURL2) => {
    isRefreshing.value = true;
    try {
      const refreshToken = localStorage.getItem("refreshToken");
      const response = await axios.post(`${baseURL2}/auth/refresh`, { refreshToken });
...
const $IMAGE_UPLOAD_ENDPOINT = $GATEWAY_ENDPOINT + "/upload";
const GATEWAY_ENDPOINT = axios.create({
  baseURL: $GATEWAY_ENDPOINT
});
const GATEWAY_ENDPOINT_V2 = axios.create({
  baseURL: $GATEWAY_ENDPOINT_V2
});
const GATEWAY_ENDPOINT_WITH_AUTH = axios.create({
  baseURL: $GATEWAY_ENDPOINT
});
const GATEWAY_ENDPOINT_WITH_AUTH_FORM_DATA = axios.create({
  baseURL: $GATEWAY_ENDPOINT,
  headers: {
    "Content-Type": "multipart/form-data"
  }
});
const GATEWAY_ENDPOINT_WITHOUT_VERSION = axios.create({
  baseURL: $GATEWAY_ENDPOINT_WITHOUT_VERSION
});
const GATEWAY_ENDPOINT_WITHOUT_VERSION_WITH_AUTH = axios.create({
  baseURL: $GATEWAY_ENDPOINT_WITHOUT_VERSION
});
axios.create({
    ...
    (err) => {
      ...
      if (err.response.status === 401) {
        ...
        if (tokenManager.isTokenRefreshing()) {
          return tokenManager.queueFailedRequest().then((newToken) => {
            originalRequest.headers.Authorization = `Bearer ${newToken}`;
            return instance(originalRequest);
          }).catch((error) => Promise.reject(error));
        }
        return tokenManager.refreshAccessToken($GATEWAY_ENDPOINT).then((newAccessToken) => {
...
const cms_api = {
  getConfig: (lang) => GATEWAY_ENDPOINT.get(`/cms${lang ? `?lang=${lang}` : ""}`)
};
const useCMS = () => {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ScreenLoader = __nuxt_component_0;
      const _component_AppToast = __nuxt_component_1;
      const _component_NuxtLayout = __nuxt_component_2;
      const _component_NuxtPage = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_ScreenLoader, { loading: pageLoading.value }, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BYYztlDb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-dnva1jwo.mjs'));
...
export { GATEWAY_ENDPOINT as G, _export_sfc as _, useCustomToast as a, useSeoMeta as b, useRouter as c, useNuxtApp as d, entry_default as default, encodeRoutePath as e, useRuntimeConfig as f, nuxtLinkDefaults as g, useCMS as h, useAppConfig as i, useAsyncData as j, useI18n as k, useRoute as l, _imports_0 as m, navigateTo as n, useCookie as o, resolveRouteObject as r, useHead as u };
