<template>
  <div class="relative bg-slate-50 py-12 sm:py-16 overflow-hidden">
    <!-- Subtle Background Element -->
    <div class="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
      <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-emerald-900 to-emerald-400 opacity-10 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-12">
        ...
        <div class="flex flex-col justify-center">
          <h3 class="text-2xl font-bold text-gray-900 mb-4">Building Moral Resilience</h3>
      ...
      <div class="mb-12">
        <div class="text-center mb-8">
          <h3 class="text-xl font-bold text-gray-900">Voices of Impact</h3>
          <p class="text-gray-500 text-sm mt-2">Hear from students and educators transformed by the message.</p>
        </div>
