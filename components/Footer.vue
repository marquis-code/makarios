  ...
  <div class="">
   <div class="grid grid-cols-1 lg:grid-cols-3">
     <div class="bg-[#1D1D1D] p-5 px-10 flex py-16 justify-center items-center">
       <div class="bg-[#1D1D1D]">
         <h2 class="text-2xl font-semibold text-[#EBEBEB] mb-4">MAKARIOS Initiative</h2>
         <p class="text-[#EBEBEB] mb-12">
          Improving Lives Through Health & Humanitarian Projects
         </p>
         ...
         <div class="space-y-8">
           <div class="flex items-start gap-4">
             ...
             <div>
               ...
               <a href="mailto:kika'sexamination@gmail.com" class="text-[#00BFFF] text-sm hover:underline">kika'sexamination@gmail.com</a>
             </div>
           </div>
           ...
           <div class="flex items-start gap-4">
             ...
             <div>
               ...
               <div class="flex flex-col gap-1">
                 <a href="tel:+2348034080064" class="text-[#00BFFF] text-sm hover:underline">+234 803 408 0064</a>
                 <a href="tel:+2348036671464" class="text-[#00BFFF] text-sm hover:underline">+234 803 667 1464</a>
               </div>
             </div>
           </div>
         </div>
     ...
     <div class="bg-[#161616] lg:col-span-2 py-16 flex justify-center items-center">
       <form @submit.prevent="sendMessage" class="space-y-6 w-full px-8 lg:max-w-lg mx-auto">
           ...
           <button
             ...
             class="w-full disabled:cursor-not-allowed disabled:opacity-50 bg-[#0072C6] hover:bg-[#005a9e] rounded-full text-white py-3.5 px-6 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
           >
     ...
     <div class="bg-white rounded-lg p-8 max-w-md mx-4" @click.stop>
       <div class="text-center">
         ...
         <p class="text-sm text-gray-500 mb-6">
           Your message has been redirected to WhatsApp. Please complete sending it through the WhatsApp application.
         </p>
         <button
           @click="showModal = false"
           class="bg-[#0072C6] hover:bg-[#005a9e] text-white px-4 py-2 rounded-lg transition-colors"
         >
           Close
         </button>
       </div>
