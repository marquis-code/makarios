<template>
  <div class="bg-white py-12 md:py-16 overflow-hidden">
    <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:px-8 xl:grid-cols-5">
      <!-- Header Section -->
      <div 
      ...
      <ul role="list" class="divide-y divide-gray-100 xl:col-span-3">
        <li 
          ...
          :key="index"
          class="flex flex-col gap-6 py-6 first:pt-0 last:pb-0 sm:flex-row group transition-all duration-500 hover:bg-slate-50 hover:px-6 hover:rounded-3xl"
        ...
        >
          ...
          <div class="max-w-xl flex-auto">
            <div class="flex items-center gap-3 mb-4">
              ...
              <span class="inline-flex items-center rounded-full bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-700 ring-1 ring-inset ring-emerald-700/10">
                {{ member.role }}
              </span>
            </div>
