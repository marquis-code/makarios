<template>
  <div class="pt-40 pb-24">
    <div class="container mx-auto px-6 max-w-3xl">
       <h1 class="text-4xl font-black text-brand-blue mb-10">Terms of Use</h1>
       <div class="prose prose-slate max-w-none text-slate-500 font-medium leading-[2]">
          <p class="mb-6">By accessing this portal, you agree to comply with the professional standards set by the SCPSN scientific board.</p>
          <h2 class="text-2xl font-bold text-brand-blue mt-12 mb-6">1. Membership Conduct</h2>
