<template>
  <div class="min-h-screen bg-slate-50 relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 py-32 relative z-10">
      ...
      <!-- Featured Conference -->
      <div class="mb-32" v-if="featuredConference">
        <div class="glass-dark rounded-[40px] overflow-hidden shadow-2xl flex flex-col lg:flex-row min-h-[600px] relative group">
          <div class="lg:w-1/2 relative overflow-hidden">
            ...
            <img :src="featuredConference.bannerImage || 'https://scpsn.org.ng/wp-content/uploads/2021/10/banner.jpg'" class="w-full h-full object-cover transition-transform duration-[2000ms] group-hover:scale-110" :alt="featuredConference.title" />
          ...
          <div class="lg:w-1/2 p-12 lg:p-20 flex flex-col justify-center relative z-30">
            <div class="flex items-center gap-4 mb-8">
               ...
               <span class="text-sm font-black tracking-[0.4em] text-brand-cyan">Next Major Event</span>
            </div>
            
            <h3 class="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter leading-tight">{{ featuredConference.title }}</h3>
            
            <p class="text-lg text-slate-400 mb-10 leading-relaxed font-medium line-clamp-3">
            ...
            <div class="grid grid-cols-2 gap-10 mb-12">
               <div class="space-y-2">
                 ...
                 <div class="flex items-center gap-3 text-white">
                    ...
                    <p class="text-lg font-bold">{{ featuredConference.startDate ? new Date(featuredConference.startDate).toLocaleDateString() : 'TBA' }}</p>
                 </div>
               </div>
               <div class="space-y-2">
                 ...
                 <div class="flex items-center gap-3 text-white">
                    ...
                    <p class="text-lg font-bold">{{ featuredConference.venue || 'TBA' }}</p>
                 </div>
               </div>
            </div>

            <div class="flex flex-wrap gap-6">
              <NuxtLink :to="`/conferences/${featuredConference._id}`" class="btn-premium">View Event Details</NuxtLink>
            </div>
          </div>
        </div>
      </div>
