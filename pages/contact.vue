  ...
  <div class="min-h-screen bg-slate-50 relative overflow-hidden">
    ...
    <section class="relative pt-40 pb-20 overflow-hidden bg-[#033958]">
      ...
      <div class="container mx-auto px-6 relative z-10 text-center space-y-6">
        <span class="inline-block px-4 py-1 glass text-brand-cyan font-black text-[10px]  -[0.4em] rounded-full">
           Strategic Hub
        </span>
      ...
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-24">
          <div v-for="info in contactInfo" :key="info.title" class="interactive-card text-center group">
            ...
            <h4 class="text-xl font-black text-brand-dark mb-4 tracking-tighter ">{{ info.title }}</h4>
            <div class="space-y-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
            ...
            <div class="lg:col-span-5 space-y-12">
               ...
               <div class="glass p-10 rounded-[40px] border border-slate-200 relative overflow-hidden group">
                  ...
                  <h5 class="text-xs font-black text-brand-dark  tracking-[0.3em] mb-8 flex items-center gap-3">
            ...
            <div class="lg:col-span-7 relative">
                <div class="interactive-card p-12 lg:p-16 relative z-10">
                   ...
                   <div class="flex gap-2 p-1 bg-slate-100 rounded-2xl mb-12">
                     <button @click="contactTab = 'appointment'" :class="['flex-1 py-3 text-[10px] font-black  rounded-xl transition-all', contactTab === 'appointment' ? 'bg-white text-brand-dark shadow-sm' : 'text-slate-400']">Appointment</button>
                     <button @click="contactTab = 'enquiry'" :class="['flex-1 py-3 text-[10px] font-black  rounded-xl transition-all', contactTab === 'enquiry' ? 'bg-white text-brand-dark shadow-sm' : 'text-slate-400']">General Inquiry</button>
                   </div>
                   ...
                   <form v-if="contactTab === 'appointment'" @submit.prevent="submitAppointment" class="space-y-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                      <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Designation & Name</label>
                        <input v-model="appointment.fullName" type="text" required class="form-input" placeholder="Dr. John Doe, MLS" />
                      </div>
                      <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Official Email</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                      <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Priority Date</label>
                        <div class="relative">
                           <input v-model="appointment.date" type="date" required class="form-input" />
                        </div>
                      </div>
                      <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Engagement Intent</label>
                        <div class="relative">
                    ...
                    <div class="space-y-3">
                      <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Brief Context</label>
                   ...
                   <form v-else @submit.prevent="submitEnquiry" class="space-y-8">
                     <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Your Name</label>
                        <input v-model="enquiryPayload.fullName" type="text" required class="form-input" placeholder="Full Name" />
                     </div>
                     <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Email Address</label>
                        <input v-model="enquiryPayload.email" type="email" required class="form-input" placeholder="john@example.com" />
                     </div>
                     <div class="space-y-3">
                        <label class="text-[10px] font-black text-brand-dark  tracking-[0.2em] ml-2">Message</label>
